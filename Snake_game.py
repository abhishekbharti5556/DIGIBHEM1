...
class Game:
    def __init__(self):
        pygame.init()
        pygame.display.set_caption("Snake Game By Abhishek Bharti")
    ...
    def render_background(self):
        bg = pygame.image.load("back ground.png")  # Load your background image
        bg = pygame.transform.scale(bg, (1000, 800))  # Resize the background image
    ...
    def show_game_over(self):
        ...
        self.surface.blit(line1, (225, 300))
